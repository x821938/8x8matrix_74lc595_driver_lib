#ifndef _8X8MATRIX74LC595_h
#define _8X8MATRIX74LC595_h

#define HWSPI // Our 74lc595 is connected to CLK and MOSI on our arduino. Hardware SPI is faster than sw.
...
/* 8x8 font. 8 bytes per letter, each byte representing each line.
   Stored in PROGMEM to save valuable SRAM */
const byte FONTMAP[128][8] PROGMEM = {
